...
// Convergence threshold for pivot binary search in filtered prob kernels
...
// ==================== Fused TopK-TopP Sampling + Filter ====================
// The following code implements a fused kernel that combines sampling with
// filtered probability output, optimized with CUDA Cluster for small batches.
